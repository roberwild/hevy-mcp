 ...
 */
export interface WithWorkoutItemRequestBuilder
	extends BaseRequestBuilder<WithWorkoutItemRequestBuilder> {
	/**
 ...
 */
export const WithWorkoutItemRequestBuilderUriTemplate =
	"{+baseurl}/v1/workouts/{workoutId}";
/**
