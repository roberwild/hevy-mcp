...
// @ts-ignore
import {
	type PostWorkoutsRequestBody,
	type Workout,
	createWorkoutFromDiscriminatorValue,
	serializePostWorkoutsRequestBody,
	serializeWorkout,
} from "../../models/index.js";
// @ts-ignore
import {
	type CountRequestBuilder,
	CountRequestBuilderRequestsMetadata,
} from "./count/index.js";
// @ts-ignore
import {
	type EventsRequestBuilder,
	EventsRequestBuilderRequestsMetadata,
} from "./events/index.js";
// @ts-ignore
import {
	type WithWorkoutItemRequestBuilder,
	WithWorkoutItemRequestBuilderRequestsMetadata,
} from "./item/index.js";
 ...
 */
// @ts-ignore
export function createWorkout400ErrorFromDiscriminatorValue(
 ...
 */
// @ts-ignore
export function createWorkoutsGetResponseFromDiscriminatorValue(
	parseNode: ParseNode | undefined,
): (instance?: Parsable) => Record<string, (node: ParseNode) => void> {
 ...
 */
// @ts-ignore
export function deserializeIntoWorkout400Error(
	workout400Error: Partial<Workout400Error> | undefined = {},
 ...
 */
// @ts-ignore
export function deserializeIntoWorkoutsGetResponse(
	workoutsGetResponse: Partial<WorkoutsGetResponse> | undefined = {},
): Record<string, (node: ParseNode) => void> {
	return {
		page: (n) => {
		...
		workouts: (n) => {
			workoutsGetResponse.workouts = n.getCollectionOfObjectValues<Workout>(
				createWorkoutFromDiscriminatorValue,
			);
		},
	};
 ...
 */
// @ts-ignore
export function serializeWorkout400Error(
	writer: SerializationWriter,
	workout400Error: Partial<Workout400Error> | undefined | null = {},
): void {
	if (workout400Error) {
 ...
 */
// @ts-ignore
export function serializeWorkoutsGetResponse(
	writer: SerializationWriter,
	workoutsGetResponse: Partial<WorkoutsGetResponse> | undefined | null = {},
): void {
	if (workoutsGetResponse) {
		...
		writer.writeCollectionOfObjectValues<Workout>(
			"workouts",
			workoutsGetResponse.workouts,
			serializeWorkout,
		);
		writer.writeAdditionalData(workoutsGetResponse.additionalData);
	}
}
export interface Workout400Error
 ...
 */
export interface WorkoutsRequestBuilder
	extends BaseRequestBuilder<WorkoutsRequestBuilder> {
	/**
	 * The count property
	 */
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<WorkoutsRequestBuilderGetQueryParameters>
			| undefined,
	): Promise<WorkoutsGetResponse | undefined>;
	/**
 ...
 */
export const WorkoutsRequestBuilderUriTemplate =
	"{+baseurl}/v1/workouts{?page*,pageSize*}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const WorkoutsRequestBuilderNavigationMetadata: Record<
	Exclude<keyof WorkoutsRequestBuilder, KeysToExcludeForNavigationMetadata>,
	NavigationMetadata
> = {
	byWorkoutId: {
