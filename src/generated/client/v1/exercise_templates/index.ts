...
// @ts-ignore
import {
	type WithExerciseTemplateItemRequestBuilder,
	WithExerciseTemplateItemRequestBuilderRequestsMetadata,
} from "./item/index.js";
 ...
 */
// @ts-ignore
export function createExercise_templatesGetResponseFromDiscriminatorValue(
 ...
 */
// @ts-ignore
export function deserializeIntoExercise_templatesGetResponse(
	exercise_templatesGetResponse:
		| Partial<Exercise_templatesGetResponse>
		| undefined = {},
): Record<string, (node: ParseNode) => void> {
	return {
		exercise_templates: (n) => {
			exercise_templatesGetResponse.exerciseTemplates =
				n.getCollectionOfObjectValues<ExerciseTemplate>(
					createExerciseTemplateFromDiscriminatorValue,
				);
		},
		page: (n) => {
...
export interface Exercise_templatesGetResponse
 ...
 */
export interface Exercise_templatesRequestBuilder
	extends BaseRequestBuilder<Exercise_templatesRequestBuilder> {
	/**
	...
	): WithExerciseTemplateItemRequestBuilder;
	/**
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<Exercise_templatesRequestBuilderGetQueryParameters>
			| undefined,
	): Promise<Exercise_templatesGetResponse | undefined>;
	/**
	 * Get a paginated list of exercise templates available on the account.
	 * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
// @ts-ignore
export function serializeExercise_templatesGetResponse(
	...
	if (exercise_templatesGetResponse) {
		writer.writeCollectionOfObjectValues<ExerciseTemplate>(
			"exercise_templates",
			exercise_templatesGetResponse.exerciseTemplates,
			serializeExerciseTemplate,
		);
		...
		writer.writeNumberValue(
			"page_count",
			exercise_templatesGetResponse.pageCount,
		);
 ...
 */
export const Exercise_templatesRequestBuilderUriTemplate =
	"{+baseurl}/v1/exercise_templates{?page*,pageSize*}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const Exercise_templatesRequestBuilderNavigationMetadata: Record<
	Exclude<
		keyof Exercise_templatesRequestBuilder,
		KeysToExcludeForNavigationMetadata
	>,
	NavigationMetadata
> = {
...
export const Exercise_templatesRequestBuilderRequestsMetadata: RequestsMetadata =
	{
		get: {
			...
			responseBodyFactory:
				createExercise_templatesGetResponseFromDiscriminatorValue,
		},
	};
/* tslint:enable */
/* eslint-enable */
