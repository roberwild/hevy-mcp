...
// @ts-ignore
import {
	type PostRoutinesRequestBody,
	type Routine,
	createRoutineFromDiscriminatorValue,
	serializePostRoutinesRequestBody,
	serializeRoutine,
} from "../../models/index.js";
// @ts-ignore
import {
	type WithRoutineItemRequestBuilder,
	WithRoutineItemRequestBuilderRequestsMetadata,
} from "./item/index.js";
 ...
 */
// @ts-ignore
export function createRoutine403ErrorFromDiscriminatorValue(
	parseNode: ParseNode | undefined,
): (instance?: Parsable) => Record<string, (node: ParseNode) => void> {
 ...
 */
// @ts-ignore
export function createRoutinesGetResponseFromDiscriminatorValue(
	parseNode: ParseNode | undefined,
): (instance?: Parsable) => Record<string, (node: ParseNode) => void> {
 ...
 */
// @ts-ignore
export function deserializeIntoRoutine403Error(
	routine403Error: Partial<Routine403Error> | undefined = {},
): Record<string, (node: ParseNode) => void> {
	return {
		error: (n) => {
 ...
 */
// @ts-ignore
export function deserializeIntoRoutinesGetResponse(
	routinesGetResponse: Partial<RoutinesGetResponse> | undefined = {},
): Record<string, (node: ParseNode) => void> {
	return {
		page: (n) => {
		...
		routines: (n) => {
			routinesGetResponse.routines = n.getCollectionOfObjectValues<Routine>(
				createRoutineFromDiscriminatorValue,
			);
		},
	};
...
export interface Routine403Error
	extends AdditionalDataHolder,
		ApiError,
		Parsable {
	/**
 ...
 */
export interface RoutinesRequestBuilder
	extends BaseRequestBuilder<RoutinesRequestBuilder> {
	/**
	...
	get(
		requestConfiguration?:
			| RequestConfiguration<RoutinesRequestBuilderGetQueryParameters>
			| undefined,
	): Promise<RoutinesGetResponse | undefined>;
	/**
 ...
 */
// @ts-ignore
export function serializeRoutine403Error(
	writer: SerializationWriter,
	routine403Error: Partial<Routine403Error> | undefined | null = {},
): void {
	if (routine403Error) {
 ...
 */
// @ts-ignore
export function serializeRoutinesGetResponse(
	writer: SerializationWriter,
	routinesGetResponse: Partial<RoutinesGetResponse> | undefined | null = {},
): void {
	if (routinesGetResponse) {
		...
		writer.writeCollectionOfObjectValues<Routine>(
			"routines",
			routinesGetResponse.routines,
			serializeRoutine,
		);
 ...
 */
export const RoutinesRequestBuilderUriTemplate =
	"{+baseurl}/v1/routines{?page*,pageSize*}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const RoutinesRequestBuilderNavigationMetadata: Record<
	Exclude<keyof RoutinesRequestBuilder, KeysToExcludeForNavigationMetadata>,
	NavigationMetadata
> = {
	byRoutineId: {
