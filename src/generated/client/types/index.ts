...
export type { PostRoutinesRequestSetTypeEnum, PostRoutinesRequestSet } from './PostRoutinesRequestSet.ts'
export type {
...
export type { PostWorkoutsRequestSetTypeEnum, PostWorkoutsRequestSetRpeEnum, PostWorkoutsRequestSet } from './PostWorkoutsRequestSet.ts'
...
export type { PutRoutinesRequestSetTypeEnum, PutRoutinesRequestSet } from './PutRoutinesRequestSet.ts'
export type {
